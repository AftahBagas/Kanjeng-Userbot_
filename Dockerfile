...
#RUN git clone https://github.com/AftahBagas/kanjeng-userbot /root/userbot
RUN wget https://raw.githubusercontent.com/AftahBagas/kanjeng-userbot/master/kanjengmain.py
RUN wget https://raw.githubusercontent.com/AftahBagas/kanjeng-userbot/master/requirements.txt
#RUN mkdir /root/userbot/bin/
#WORKDIR /root/userbot/
#RUN chmod +x /usr/local/bin/*
RUN pip3 install -r requirements.txt
#CMD ["bash","boot_start.sh"]
CMD ["python3","kanjengmain.py"]
